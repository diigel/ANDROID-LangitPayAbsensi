...
abstract class BaseAdapter<T> : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    fun addList(list: List<T>, listResult: ((MutableList<T>) -> Unit)? = null) {
        ...
        try {
            this.list.removeDuplicatesItem()
    ...
    fun addItem(item: T, listResult: ((MutableList<T>) -> Unit)? = null) {
        ...
        val diffCallback = BaseDiffCallback(this.list, newList)
        val diffResult = DiffUtil.calculateDiff(diffCallback)
    ...
    fun removeItem(item: T?) {
        ...
        val diffCallback = BaseDiffCallback(this.list, singleList)
        val diffResult = DiffUtil.calculateDiff(diffCallback)
    ...
    fun removePosition(position: Int) {
        ...
        val diffCallback = BaseDiffCallback(this.list, listRemoved)
        val diffResult = DiffUtil.calculateDiff(diffCallback)
        listRemoved.removeDuplicatesItem()
        diffResult.dispatchUpdatesTo(this)
    }
    ...
    abstract fun bindShimmer(parent: ViewGroup): View?
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        if (getItemViewType(position) == ITEM_TYPE) {
            ...
            (holder as NetworkStateItemsViewHolder).bind(networkState, bindShimmer(parent))
        }
    }
